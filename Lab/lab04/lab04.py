...
def distance(city_a, city_b):
    ...
    5.0
    """
    recei_1,recei_2 = get_lat(city_a),get_lon(city_a)
    recei_b1,recei_b2 = get_lat(city_b),get_lon(city_b)
    return sqrt((recei_1 - recei_b1)**2 + (recei_2 - recei_b2)**2)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    c_1 = distance(city_a,city_c) 
    c_2 = distance(city_b,city_c)
    if c_1 >= c_2:
