...
def balanced(m):
    ...
    if is_planet(m):
        ...
        left_li = length(left(m)) * total_mass(left_end)
        right_li = length(right(m)) * total_mass(right_end)
        return left_li == right_li and balanced(left_end) and balanced(right_end)
